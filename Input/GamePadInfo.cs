...
///<summary> Get the index of the player this gamepad is for </summary>
public PlayerIndex PlayerIndex {get;}

///<summary>Stores the previous gamepad update cycle.</summary>
public GamePadState PreviousState { get; private set; }

///<summary>Stores the current gamepad update cycle.</summary>
public GamePadState CurrentState { get; private set; }

///<summary>Returns a bool on whether or not the gamepad is connected.</summary>
public bool IsConnected => CurrentState.IsConnected;


///<summary>Gets the value of the left thumbstick.</summary>
public Vector2 LeftThumbstick => CurrentState.ThumbSticks.Left;

///<summary>Gets the value of the right thumbstick.</summary>
public Vector2 RightThumbstick => CurrentState.ThumbSticks.Right;

///<summary>Gets the value of the left trigger.</summary>
public float LeftTrigger => CurrentState.Triggers.Left;

///<summary>Gets the value of the right trigger.</summary>
public float RightTrigger => CurrentState.Triggers.Right;

///<summary>Creates a new GamePadInfo for the gamepad connected at specific player</summary>
...
///<summary> Updates the state information for this gamepad input.</summary>
