...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    ///<summary>
    /// Gets the loctaion of the center of this circle.
    ///</summary>
    ...
    ///<summary>
    /// Gets a value that indicates whether this circle is empty
    ///</summary>
    ...
    /// Creates a new circle with the specified position and radius.
    /// </summary>
    /// <param name="location">The center of the circle-coordinate of the center of the circle.</param>
    /// <param name="radius">The length from the center of the circle to an edge.</param>
    ...
    public bool Intersects(Circle other)
    {
        ...
        float distinceSquared = Vector2.DistanceSquared(this.Location.ToVector2(), other.Location.ToVector2());
        return distinceSquared < radiiSquared;
    }
    ...
    /// <summary>
    /// Returns a value that indicates if the circle on the left hand side of the equality operator is not equal to the
    /// circle on the right hand side of the equality operator.
    /// </summary>
    /// <param name="lhs">The circle on the left hand side of the equality operator.</param>
    /// <param name="rhs">The circle on the right hand side of the equality operator.</param>
    /// <returns>true if the two circles not equal; otherwise, false.</returns>
    public static bool operator !=(Circle lhs, Circle rhs) => !lhs.Equals(rhs);
